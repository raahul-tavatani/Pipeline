...
DEMO_SCRIPT = Path(r"C:\Pipeline\Scripts\\demo.py")
CFG_FILE = "C:\Pipeline\\cfgs\\kitti_models\\pv_rcnn.yaml"
CKPT_PATH = r"C:\Pipeline\OpenPCDet-Win11-Compatible\pv_rcnn_8369.pth"  # ← Update this path to your actual model checkpoint
...
def run_demo_on_bin(bin_file: Path, cfg_file: str, ckpt_path: str, pred_json_dir: Path):
    ...
    # Remove old prediction_000.json if it exists
    if Path("prediction_000.json").exists():
        Path("prediction_000.json").unlink()
